...
public class EntityPackets {
    ...
    public static void register(final BedrockProtocol protocol) {
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.ADD_ITEM_ENTITY, ClientboundPackets26_1.ADD_ENTITY, wrapper -> {
            ...
            entity.setPosition(position);
            net.raphimc.viabedrock.experimental.VppResync.rememberItemEntity(wrapper.user(), entityRuntimeId, item); // VP+ pickup emulation
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.TAKE_ITEM_ENTITY, ClientboundPackets26_1.TAKE_ITEM_ENTITY, wrapper -> {
            ...
            final net.raphimc.viabedrock.protocol.model.BedrockItem vppPicked =
                    net.raphimc.viabedrock.experimental.VppResync.takeItemEntity(wrapper.user(), itemEntityRuntimeId);
            if (collectorEntity == entityTracker.getClientPlayer() && vppPicked != null && !vppPicked.isEmpty()) {
                net.raphimc.viabedrock.experimental.VppResync.emulatePickup(wrapper.user(), vppPicked); // VP+ Bedrock-client pickup behavior
            }
